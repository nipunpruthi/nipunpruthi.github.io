...
Now, we have started the image. Subsequent steps are not length as to run the image.
Using 
> docker ps -a

we can see the initialized container from our buit image(lets say 213lafl21l).
